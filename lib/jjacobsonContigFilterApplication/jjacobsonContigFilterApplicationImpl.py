...
class jjacobsonContigFilterApplication:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_jjacobsonContigFilterApplication(self, ctx, params):
        """
        ...
        #BEGIN run_jjacobsonContigFilterApplication

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_jjacobsonContigFilterApplication function. Params=' + pformat(params))
        ...
        #END run_jjacobsonContigFilterApplication

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_jjacobsonContigFilterApplication return value ' +
