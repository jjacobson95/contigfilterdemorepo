...
SERVICE_CAPS = jjacobsonContigFilterApplication
SPEC_FILE = jjacobsonContigFilterApplication.spec
URL = https://kbase.us/services/jjacobsoncontigfilterapplication
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
